    ...
    public partial class RecipeInput
    {
        ...
        public void StoreTempData()
        {
            ...
            try
            {
                ...
                LoadedRecipe._tempHigherAlarmValue = Convert.ToDouble(highTempTxt.Text);
                LoadedRecipe._tempSetpoint = Convert.ToDouble(tempSetTxt.Text);
                LoadedRecipe._tempLowerAlarmValue = Convert.ToDouble(lowTempTxt.Text);
                LoadedRecipe._sealTime = Convert.ToDouble(sealTimeTxt.Text);
                LoadedRecipe._pressureUpperAlarmValue = Convert.ToDouble(highPressTxt.Text);
                LoadedRecipe._pressureSetpointFromOIT = Convert.ToDouble (pressSetTxt.Text);
                LoadedRecipe._pressureLowerAlarmValue = Convert.ToDouble(lowPressureTxt.Text);
